                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.875rem' }}>
                    <thead>
                        <tr style={{ background: '#f8fafc', textAlign: 'left' }}>
                            {['User', 'Email', 'Date', 'Goal Type', 'Calorie Goal', 'Protein Goal', 'Carb Goal', 'Fat Goal', ''].map(h => (
                    ...
                    <tbody>
                        {goals.map(g => (
                            <tr key={g.id} style={{ borderBottom: '1px solid #f1f5f9' }}>
                                <td style={{ padding: '0.75rem 1rem', fontWeight: 600, color: '#020617' }}>{g.user_name}</td>
                        ...
                        {!goals.length && !loading && (
                            <tr><td colSpan={9} style={{ padding: '3rem', textAlign: 'center', color: '#94a3b8' }}>No goals found.</td></tr>
                        )}
                    </tbody>
                </table>
            </div>
