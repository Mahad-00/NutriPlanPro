                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.875rem' }}>
                    <thead>
                        <tr style={{ background: '#f8fafc', textAlign: 'left' }}>
                            {['Name', 'Brand', 'Fit Score', 'Calories', 'Protein', 'Carbs', 'Fiber', 'Meal Type', 'Action', ''].map(h => (
                    ...
                    <tbody>
                        ...
                        {!recs.length && !loading && (
                            <tr><td colSpan={10} style={{ padding: '3rem', textAlign: 'center', color: '#94a3b8' }}>No diet recommendations found.</td></tr>
                        )}
                    </tbody>
                </table>
            </div>
